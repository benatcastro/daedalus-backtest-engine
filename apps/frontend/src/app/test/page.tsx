// @ts-nocheck - experimental scratch/playground page; its <Marker> usage predates
// the current Marker component API (dataFeed-based). Excluded from type-checking
// so it doesn't block production builds. Update or remove when revisiting the demo.
"use client";
...
export default function Page() {
    ...
    return (
        <div>
            <h1>Chart with markers</h1>
            <Card className="h-[38rem] m-32">
                <Chart>
                    <Series type={"candlestick"} data={data}>
                        <Marker markers={markers}></Marker>
                    </Series>
                </Chart>
            </Card>
        </div>
