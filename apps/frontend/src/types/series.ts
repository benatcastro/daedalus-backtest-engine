...
export interface SeriesMetadata {
    ...
    parameters: Record<string, unknown>; // Chart parameters and configuration options
}
...
export interface Series extends SeriesMetadata {
    data: Record<string, unknown>[]; // Chart data in JSON format containing time-based series data
}
