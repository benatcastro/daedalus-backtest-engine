                                        ...
                                        <>
                                            ...
                                            <div className="flex flex-col items-center">
                                                ...
                                                <span className="text-xs text-muted-foreground">
                                                    You can select a folder containing your backtest
                                                    files
                                                </span>
                                            </div>
                                            <input
            ...
            <AlertDialog open={showFolderAlert} onOpenChange={setShowFolderAlert}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            You cannot drag and drop folders directly. Please use the "Click to
                            select a folder" button instead to upload folder contents.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
