 ...
 */
export function UploadBacktestButton({ strategy, onNewBacktest }: UploadBacktestButtonProps) {
            ...
            <Dialog open={isOpen} onOpenChange={() => setIsOpen(!isOpen)}>
                ...
                <DialogContent className="sm:max-w-[64rem] h-4/6">
                    <DialogHeader>
                        ...
                        <DialogDescription>Upload a new backtest to be analyzed</DialogDescription>
                    </DialogHeader>
