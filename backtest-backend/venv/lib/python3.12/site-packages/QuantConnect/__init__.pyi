...
class Extensions(System.Object):
    ...
    @staticmethod
    def get_entry(market_hours_database: QuantConnect.Securities.MarketHoursDatabase, symbol: typing.Union[QuantConnect.Symbol, str, QuantConnect.Data.Market.BaseContract], data_types: typing.Iterable[typing.Type]) -> QuantConnect.Securities.MarketHoursDatabase.Entry:
        """
    ...
    @staticmethod
    def greatest_common_divisor(values: typing.Iterable[int]) -> int:
        """
    ...
    @staticmethod
    def order_targets_by_margin_impact(targets: typing.Iterable[QuantConnect.Algorithm.Framework.Portfolio.IPortfolioTarget], algorithm: QuantConnect.Interfaces.IAlgorithm, target_is_delta: bool = False) -> typing.Iterable[QuantConnect.Algorithm.Framework.Portfolio.IPortfolioTarget]:
        """
...
class TimeKeeper(System.Object, QuantConnect.Interfaces.ITimeKeeper):
    ...
    @overload
    def __init__(self, utc_date_time: typing.Union[datetime.datetime, datetime.date], time_zones: typing.Iterable[DateTimeZone]) -> None:
        """
        Initializes a new instance of the TimeKeeper class at the specified
        UTC time and for the specified time zones. Each time zone specified will cause the
        creation of a LocalTimeKeeper to handle conversions for that time zone.
...
class Time(System.Object):
    ...
    @staticmethod
    def tradable_date(securities: typing.Iterable[QuantConnect.Securities.Security], day: typing.Union[datetime.datetime, datetime.date]) -> bool:
        """
...
class Compression(System.Object):
    ...
    @staticmethod
    @overload
    def zip_bytes_async(target: System.IO.Stream, data: typing.Iterable[System.Collections.Generic.KeyValuePair[typing.List[int], str]], mode: typing.Optional[ZipArchiveMode] = None, compression_level: typing.Optional[CompressionLevel] = None) -> System.Threading.Tasks.Task:
        """
        Performs an in memory zip of the specified bytes in the target stream
    ...
    @staticmethod
    @overload
    def zip_data(zip_path: str, filenames_and_data: typing.Iterable[System.Collections.Generic.KeyValuePair[str, typing.List[int]]]) -> bool:
        """
    ...
    @staticmethod
    @overload
    def zip_data(zip_path: str, zip_entry: str, lines: typing.Iterable[str]) -> bool:
        """
    ...
    @staticmethod
    def zip_files(destination: str, files: typing.Iterable[str]) -> None:
        """Zips all files specified to a new zip at the destination path"""
        ...

    @staticmethod
    @overload
    def zip_streams_async(target: str, data: typing.Iterable[System.Collections.Generic.KeyValuePair[str, System.IO.Stream]], mode: typing.Optional[ZipArchiveMode] = None, compression_level: typing.Optional[CompressionLevel] = None) -> System.Threading.Tasks.Task:
        """
    ...
    @staticmethod
    @overload
    def zip_streams_async(target: System.IO.Stream, data: typing.Iterable[System.Collections.Generic.KeyValuePair[str, System.IO.Stream]], mode: typing.Optional[ZipArchiveMode] = None, compression_level: typing.Optional[CompressionLevel] = None, leave_stream_open: bool = False) -> System.Threading.Tasks.Task:
        """
        Performs an in memory zip of the specified stream in the target stream
...
class Messages(System.Object):
    ...
    class PositionGroup(System.Object):
        ...
        @staticmethod
        def invalid_quantity(quantity: float, positions: typing.Iterable[QuantConnect.Securities.Positions.IPosition]) -> str:
            """
    ...
    class SymbolCache(System.Object):
        ...
        @staticmethod
        def multiple_matching_tickers_located(tickers: typing.Iterable[str]) -> str:
    ...
    class Cash(System.Object):
        ...
        @staticmethod
        def no_tradable_pair_found_for_currency_conversion(cash_currency_symbol: str, account_currency: str, market_map: typing.Iterable[System.Collections.Generic.KeyValuePair[QuantConnect.SecurityType, str]]) -> str:
            """
    ...
    class MarketHoursDatabase(System.Object):
        ...
        @staticmethod
        def exchange_hours_not_found(key: QuantConnect.Securities.SecurityDatabaseKey, available_keys: typing.Iterable[QuantConnect.Securities.SecurityDatabaseKey] = None) -> str:
            """
    ...
    class DefaultBrokerageModel(System.Object):
        ...
        @staticmethod
        def unsupported_order_type(brokerage_model: QuantConnect.Brokerages.IBrokerageModel, order: QuantConnect.Orders.Order, supported_order_types: typing.Iterable[QuantConnect.Orders.OrderType]) -> str:
            """
